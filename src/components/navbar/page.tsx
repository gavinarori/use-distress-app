            ...
            <div className="flex space-x-4">
                ...
                <div hidden className="md:block">
                    <div className="relative flex items-center text-gray-400 focus-within:text-cyan-400">
                        ...
                        <input type="search" name="leadingIcon" id="leadingIcon" placeholder="Search here" className="w-full pl-14 pr-4 py-2.5 rounded-xl text-sm text-gray-600 outline-none border border-gray-300 focus:border-[#FF8080] transition" />
                    </div>
                </div>
                {/*/search bar */}
                ...
                <button aria-label="chat" className="w-10 h-10 rounded-xl border bg-[#FF8080] focus:bg-gray-100 active:bg-gray-200">
                ...
                <button aria-label="notification" className="w-10 h-10 rounded-xl border bg-[#FF8080] focus:bg-gray-100 active:bg-gray-200">
