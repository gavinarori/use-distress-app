...
const Pricing = () => {
  return (
    <div className="space-y-5 px-8  py-12 justify-center">
    <div className="container flex space-x-2 mt-12">
        <div className="no-scrollbar overflow-hidden">
            <div className="flex no-scrollbar justify-start space-x-6 items-center overflow-x-auto">
                <button
                    className="font-semibold whitespace-nowrap text-base text-gray-500 hover:text-gray-600 transition-colors duration-300">Monthly</button><button
                    className="font-semibold whitespace-nowrap text-base hover:text-gray-600 transition-colors duration-300 text-gray-900">Annually</button>
            </div>
        </div><button className="text-purple-500 font-semibold text-base">(2 months free)</button>
    </div>
